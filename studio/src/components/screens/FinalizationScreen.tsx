      ...
      <div className="space-y-6">
        ...
        <div className="p-4 bg-slate-50 border border-slate-200 rounded-lg space-y-2">
          <p className="text-xs text-slate-500">
            <strong>Governance Notice:</strong> This system defines and proves decision authority. It does not execute decisions.
          </p>
          <p className="text-xs text-slate-500">
            Finalization is governance approval, not deployment. Artifacts are intended for enforcement by downstream systems.
          </p>
        </div>
